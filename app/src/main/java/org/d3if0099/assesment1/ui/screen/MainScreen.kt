package org.d3if0099.assesment1.ui.screen
...
import org.d3if0099.assesment1.R
import org.d3if0099.assesment1.navigation.Screen
import org.d3if0099.assesment1.ui.theme.Assesment1Theme
...
fun ScreenContent(modifier: Modifier) {
    ...
    val radioOptions1 = listOf(
        stringResource(id = R.string.hotel1)
    )
    val radioOptions2 = listOf(
        stringResource(id = R.string.hotel2)
    )
    val radioOptions3 = listOf(
        stringResource(id = R.string.hotel3)
    )
    val radioOptions4 = listOf(
        stringResource(id = R.string.hotel4)
    )
    ...
    var hotelList by rememberSaveable { mutableStateOf(radioOptions1[0]) }
    ...
    Column(
        ...
        Text(
            text = stringResource(id = R.string.intro_booktel),
                ...
                Column {
                    ...
                    Row(
                        ...
                        radioOptions1.forEach { text ->
                            VehicleOption(
                                label = text,
                                isSelected = hotelList == text,
                                modifier = Modifier
                                    .selectable(
                                        selected = hotelList == text,
                                        onClick = { hotelList = text },
        ...
        fun hitungTotalHarga(jumlah: Float): Float {
            val priceDefault = 400000f
            var timePriceModifier = 1.0f

            timePriceModifier = when (timeList) {
                radioOptions[0] -> 1f // 1 Hari
                radioOptions[1] -> 3f // 3 Hari
                radioOptions[2] -> 7f // 1 Minggu
                radioOptions[3] -> 14f // 2 Minggu
                else -> timePriceModifier
            }

            return jumlah * priceDefault * timePriceModifier
        }
                ...
                onClick = {
                    shareData(
                        ...
                        message = context.getString(R.string.bagikan_template,
                            jumlah, hotelList, timeList, totalHarga
                        )
                    )
                },
                modifier = Modifier.padding(top = 8.dp),
